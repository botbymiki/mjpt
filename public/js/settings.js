...
function formatPreset(preset) {
  const bristol  = `Type ${preset.bristolType}`;
...
function bindActions() {
  $("#editMikeName").addEventListener("click",     () => editName("mike"));
  $("#editJennaName").addEventListener("click",    () => editName("jenna"));
  $("#editMikeReminder").addEventListener("click", () => editReminder("mike"));
  $("#editJennaReminder").addEventListener("click",() => editReminder("jenna"));
  $("#editMikePreset").addEventListener("click",   () => editPreset("mike"));
  $("#editJennaPreset").addEventListener("click",  () => editPreset("jenna"));
}
