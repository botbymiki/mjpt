...
<div class="page">
  ...
  <!-- REMINDERS -->
  <div class="settings-group">
    <div class="settings-group-label">Daily Reminder</div>
    <div class="settings-list">
      <div class="settings-row" id="editMikeReminder">
        ...
        <div class="sr-body">
          ...
          <div class="sr-desc" id="mikeReminderDisplay">8:00 PM · Melbourne (AEST)</div>
        </div>
        <div class="sr-chevron"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></div>
      </div>
      <div class="settings-row" id="editJennaReminder">
        ...
        <div class="sr-body">
          ...
          <div class="sr-desc" id="jennaReminderDisplay">8:00 PM · WITA (UTC+8)</div>
        </div>
        <div class="sr-chevron"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></div>
      </div>
    </div>
    ...
    <div class="settings-list">
      <div class="settings-row" id="editMikePreset">
        ...
        <div class="sr-body">
          ...
          <div class="sr-desc" id="mikePresetDisplay">Type 4 · Brown · No symptoms</div>
        </div>
        <div class="sr-chevron"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></div>
      </div>
      <div class="settings-row" id="editJennaPreset">
        ...
        <div class="sr-body">
          ...
          <div class="sr-desc" id="jennaPresetDisplay">Type 4 · Brown · No symptoms</div>
        </div>
        <div class="sr-chevron"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></div>
      </div>
    </div>
    ...
    <div class="settings-list">
      ...
      <div class="settings-row" style="cursor:default">
        ...
        <div class="sr-body">
          ...
          <div class="sr-desc">Open the bot, send /start, tap your name. The bot remembers you forever.</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="settings-group">
    ...
    <div class="settings-list">
      <div class="settings-row" id="editMikeReminder">
        ...
        <div class="sr-body">
          <div class="sr-title">Mike's reminder time</div>
          <div class="sr-desc" id="mikeReminderDisplay">8:00 PM · Melbourne (AEST)</div>
        </div>
        <div class="sr-chevron"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></div>
      </div>
      <div class="settings-row" id="editJennaReminder">
        ...
        <div class="sr-body">
          <div class="sr-title">Jenna's reminder time</div>
          <div class="sr-desc" id="jennaReminderDisplay">8:00 PM · WITA (UTC+8)</div>
        </div>
        <div class="sr-chevron"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></div>
      </div>
      <div class="settings-row" style="cursor:default">
        ...
        <div class="sr-body">
          <div class="sr-title">Only if you haven't logged</div>
          <div class="sr-desc">Reminders are sent via Telegram only on days with no logs. Powered by cron-job.org.</div>
        </div>
      </div>
    </div>
  </div>
...
<nav class="nav">
  ...
  <a class="nav-btn" href="/feed.html">
  ...
  <a class="nav-btn active" href="/settings.html">
